        ...
        if "auth_user" not in db.tables:
            ...
            auth_fields = [
                ...
                Field(
                    "middle_name",
                    requires=ne,
                    label=self.param.messages["labels"].get("middle_name"),
                ),
                Field(
                    "profile_image",
                    "upload",
                    requires=ne,
                    label=self.param.messages["labels"].get("profile_image"),
                ),
                Field(
                    "hobbies",
                    requires=ne,
                    label=self.param.messages["labels"].get("hobbies"),
                ),
                Field(
                    "intrests",
                    requires=ne,
                    label=self.param.messages["labels"].get("intrests"),
                ),
                Field(
                    "location",
                    requires=ne,
                    label=self.param.messages["labels"].get("location"),
                ),
